...
class CDDrive : public Producer<int16_t> {
    ...
    public:
        ...
        /// @brief "Eject requested" signal type.
        ...
        /// @brief Thrown when the audio CD was recognized
        ...
        /// @brief CDDrive constructor.
        CDDrive();

        /// @brief CDDrive destructor.
        ~CDDrive();
        ...
        /// @brief Returns the LBA (large block address) of the start of the given track on the disc.
        ...
        /// This is one half of an audio frame which contains a left and right sample.
        /// @return The audio sample.
        int16_t next() override;

        /// @see Producer::register_consumer(const Consumer<int16_t>* const).
        /// @brief Deleted. This Producer does not support multiple \ref Consumer "Consumers".
        void register_consumer(const Consumer<int16_t>* const) = delete;
        
        /// @see Producer::next_for_consumer(const Consumer<int16_t>* const).
        /// @brief Deleted. This Producer does not support multiple \ref Consumer "Consumers".
        ...
        sig_eject signal_eject(); ///< Getter for ::_signal_eject.
    ...
    private:
        ...
        /// between the application thread and the ::Reader thread.
